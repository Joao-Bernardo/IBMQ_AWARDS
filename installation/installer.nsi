!define PRODUCT_NAME "Quantic Tetris"
!define PRODUCT_VERSION "1.0"
!define PY_VERSION "3.7.5"
!define PY_MAJOR_VERSION "3.7"
!define BITNESS "64"
!define ARCH_TAG ".amd64"
!define INSTALLER_NAME "Quantic_Tetris_1.0.exe"
...
!define MULTIUSER_INSTALLMODE_INSTDIR "Quantic Tetris"
...
Section "!${PRODUCT_NAME}" sec_app
  ...
  StrCmp $MultiUser.InstallMode CurrentUser 0 +3
    ...
    SetFileAttributes "$INSTDIR\${USER_INSTALL_MARKER}" HIDDEN
      ...
      ; Install files
    SetOutPath "$INSTDIR"
      File "Quantic_Tetris.launch.pyw"
      File "glossyorb.ico"
  ...
  SetOutPath "%HOMEDRIVE%\%HOMEPATH%"
    CreateShortCut "$SMPROGRAMS\Quantic Tetris.lnk" "$INSTDIR\Python\pythonw.exe" \
      '"$INSTDIR\Quantic_Tetris.launch.pyw"' "$INSTDIR\glossyorb.ico"
  SetOutPath "$INSTDIR"
...
Section "Uninstall"
  ...
  ; Uninstall files
    Delete "$INSTDIR\Quantic_Tetris.launch.pyw"
    Delete "$INSTDIR\glossyorb.ico"
  ; Uninstall directories
    RMDir /r "$INSTDIR\Python"

  ; Uninstall shortcuts
      Delete "$SMPROGRAMS\Quantic Tetris.lnk"
  RMDir $INSTDIR
